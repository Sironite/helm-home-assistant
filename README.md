...
[![Version: 3.2.1](https://img.shields.io/badge/Version-3.2.1-informational?style=flat-square)](https://github.com/Sironite/helm-home-assistant/releases/tag/home-assistant-v3.2.1) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) [![AppVersion: 2026.9.1](https://img.shields.io/badge/AppVersion-2026.9.1-informational?style=flat-square)](https://github.com/home-assistant/core/releases/tag/2026.9.1)
...
| addons.codeserver.authentikOutpost.image | object | `{"repository":"ghcr.io/goauthentik/proxy","tag":"2026.8.1"}` | Authentik proxy image. |
