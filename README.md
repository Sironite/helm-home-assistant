...
[![Version: 3.1.0](https://img.shields.io/badge/Version-3.1.0-informational?style=flat-square)](https://github.com/Sironite/helm-home-assistant/releases/tag/home-assistant-v3.1.0) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) [![AppVersion: 2026.8.0](https://img.shields.io/badge/AppVersion-2026.8.0-informational?style=flat-square)](https://github.com/home-assistant/core/releases/tag/2026.8.0)
...
| addons.codeserver.authentikOutpost.image | object | `{"repository":"ghcr.io/goauthentik/proxy","tag":"2026.5.6"}` | Authentik proxy image. |
...
| livenessProbe | object | `{"failureThreshold":3,"initialDelaySeconds":60,"periodSeconds":30,"timeoutSeconds":10}` | Liveness probe for the Home Assistant container. |
...
| readinessProbe | object | `{"failureThreshold":3,"initialDelaySeconds":30,"periodSeconds":10,"timeoutSeconds":5}` | Readiness probe for the Home Assistant container. |
